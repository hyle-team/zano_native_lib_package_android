...
public class PlainWalletApi {
    ...
    public native String init(String address, String workingDir, int logLevel);
    ...
    public native String getWalletStatus(long hwallet);
    public native String closeWallet(long hwallet);
    public native String invoke(long hwallet, String params);
    ...
    public native String getWalletInfo(long hwallet);
    public native String resetWalletPassword(long hwallet, String password);
